          ...
          <div className="row">
              ...
              <div className="cart-left-content">
                <div className="delivery-area box">
                  <div className="del-address">
                    <span className="sm-para">
                      Deliver To:{" "}
                      <span className="sm-title">Bangalore - 560048</span>
                    </span>
                    <a href="#" className="btns btn-md">
                      Change
                    </a>
                  </div>
                </div>
                        ...
                        <div className="row">
                          <div className="col-lg-3 ">
                            <div className="products-area box">
                              <div className="img-box">
                                <img
                                  src={require(`../Images/Products/${e.image[1]}`)}
                                  alt="Dell Alienware"
                                />
                              </div>
                            </div>
                          ...
                          <div className="col-lg-5">
                            <div className="products-area box">
                              ...
                              <p className="sm-para">
                                Seller:RoyalCommunicationsIndia
                              </p>
                              <div className="price-offer md-title">
                                ...
                                <span className="offer text-success ms-2">
                                  15% Off
                                </span>
                                <span className="coupon ms-3 text-success">
                                  1 offer applied
                                </span>
                              </div>
                            </div>
                          ...
                          <div className="col-lg-9">
                            <div className="box">
                              <button
                                className=" title save-remove "
                                onClick={saveLater.bind(this, e)}
                              >
                                Save For Later
                              </button>
                              <button
                                className=" title save-remove ms-4"
                ...
                <div className="place-order">
                  ...
                  <a href="#/payment" className="btns btn-red ">
                    Place Order
                  </a>
                </div>
              </div>
            ...
            <div className="col-lg-4">
              <div className="cart-right-content">
                <div className="price-detail-title  box title">
                  Price Details
                </div>
                ...
                <div className="price-detail-group">
                  ...
                  <span className="md-title text-success">
                    <del className="para">₹160 </del> Free
                  </span>
                </div>
                <div className="price-detail-group">
                ...
                <p className="text-success ps-3">
                  You will save ₹43,706 on this order
                </p>
              </div>
            </div>
          </div>
                  ...
                  <div className="col-lg-2 col-md-4 col-sm-12" key={e.id}>
                    <div className="card">
                      <div className="box">
                        <div
                          className="icon-box"
                          onClick={delsavelater.bind(this, e.id)}
                        >
                          <DeleteIcon />
                        </div>
                        ...
                        <div className="boxs">
                          <span className="star-box sm-title">
                            {e.rating} <StarIcon className="star" />{" "}
                          </span>
                        ...
                        <button
                          className="save-remove btns btn-yellow w-100"
