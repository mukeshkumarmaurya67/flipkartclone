                           ...
                           <div className="filter-section">
                              ...
                              <form action="">
                                 <div className="box">
                                    ...
                                    {/* Price Filter  */}
                                    <div className="d-flex justify-content-between align-items-center mb-2 mt-2 " data-bs-toggle="collapse" data-bs-target="#price" >
                                    ...
                                    {/* Brand Filter  */}
                                    <div className="d-flex justify-content-between align-items-center mb-2 mt-2 " data-bs-toggle="collapse" data-bs-target="#brand" >
                                    ...
                                    {/* Color Filter  */}
                                    <div className="d-flex justify-content-between align-items-center mb-2 mt-2 " data-bs-toggle="collapse" data-bs-target="#color" >
